...
-- ============================================================
-- 6. REGISTRO VÁLIDO DE FACT_PRODUCCION
-- ============================================================
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE EXCEPTION
            'TEST FAIL: no se pudo registrar orden de prueba';
    END IF;

    RAISE NOTICE
        'OK 6: FACT_PRODUCCION acepta un registro válido.';
END
$$;
...
BEGIN
    ...
    RAISE NOTICE
        'OK 7: FACT_CONSUMO_INSUMO acepta un registro válido y calcula desviacion.';
END
$$;
...
BEGIN
    IF NOT EXISTS (
        ...
        RAISE EXCEPTION
            'TEST FAIL: consumo_id no quedó conservado para trazabilidad';
    END IF;

    RAISE NOTICE
        'OK 9: trazabilidad mediante consumo_id verificada.';
END
$$;
