...
INSERT INTO ordenes_produccion (
    ...
    -- Julio 2026: periodo comparable con Remuneraciones
    ('OP-2026-0701', 1, '2026-07-02', '2026-07-04',
     950.00, 930.00, 18.00, 'TERMINADA', 101),

    ('OP-2026-0702', 2, '2026-07-05', '2026-07-08',
     1400.00, 1365.00, 24.00, 'TERMINADA', 102),

    ('OP-2026-0703', 3, '2026-07-09', '2026-07-11',
     850.00, 825.00, 12.00, 'TERMINADA', 103),

    ('OP-2026-0704', 4, '2026-07-13', '2026-07-16',
     900.00, 860.00, 20.00, 'TERMINADA', 104),

    ('OP-2026-0705', 5, '2026-07-18', '2026-07-21',
     750.00, 720.00, 10.00, 'TERMINADA', 105),

    ('OP-2026-0706', 2, '2026-07-23', '2026-07-26',
     1100.00, 1070.00, 17.00, 'TERMINADA', 102);
